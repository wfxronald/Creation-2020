...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { title: @submission.title, upload_id: @submission.upload_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { title: @submission.title, upload_id: @submission.upload_id } }
